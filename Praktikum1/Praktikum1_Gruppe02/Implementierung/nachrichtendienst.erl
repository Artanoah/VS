...
getMSG(DLQ, PID, ClientList, ClientLifetime) ->
	...
	util:logging(LogFileName, Msg ++ " " ++ integer_to_list(Number) ++ "te_Nachricht. COut: " ++ util:timestamp_to_list(COut) ++ 
	" HBQ In: " ++ util:timestamp_to_list(HBQIn) ++ "DLQ In: " ++ util:timestamp_to_list(DLQIn) ++ " -getmessages von " ++ pid_to_list(PID) ++ "-" ++ 
