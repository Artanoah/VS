...
public class NameServiceImplementation extends NameService {
	...
	private static Log log = new Log("NameServiceImplementation");;
	private boolean run;
		...
		try {
			...
			if(sc != null) {
				try {
					...
					log.newWarning("Schlie�en der SocketConnection fehlgeschlagen.");
					e.printStackTrace();
				}
			}
		}
	...
	public Object resolve(String name) {
		...
		try {
			...
			try {
				...
				log.newWarning("resolve: Schlie�en der SocketConnection fehlgeschlagen.");
				e.printStackTrace();
			}
		}
